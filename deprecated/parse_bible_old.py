...
output_file_path1 = 'bible/output/bible1'
output_file_path2 = 'bible/output/bible2'
bible_file_path1 = open('file_path1.txt', 'r').read()
bible_file_path2 = open('file_path2.txt', 'r').read()
...
if __name__ == '__main__':
    parse_bible(bible_file_path1, output_file_path1)
    # parse_bible(bible_file_path2, output_file_path2)